...
<body>
    ...
    <div id="main" class="container-fluid" style="margin-top: 50px">
            ...
            <div class="col-md-6">
                <form action="{{ url('/busca') }}" method="post">
                    <div class="input-group h2">
                            {{ csrf_field() }}
                            <input name="criterio" class="form-control" id="criterio" type="text" placeholder="Search Customers" value="">
        ...
        <!-- Paginação -->
        @if(isset($criterio))
            {{ $customers->appends(['criterio' => $criterio])->links() }}
        @else
            {!! $customers->links() !!}
        @endif
    </div>  <!-- /#main -->
