    ...
    <!-- area de campos do form -->
        ...
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" name="address" placeholder="Enter the Address" value="">
            </div>

            <div class="form-group col-md-3">
                <label for="bairro">City</label>
                <input type="text" class="form-control" name="city" placeholder="Enter the City" value="">
            </div>

            <div class="form-group col-md-3">
                <label for="cidade">State</label>
                <input type="text" class="form-control" name="state" placeholder="Enter the State" value="">
            </div>

            <div class="form-group col-md-3">
                <label for="cep">Zipcode</label>
                <input type="text" class="form-control" name="zipcode" placeholder="Enter the Zipcode" value="">
            </div>
        </div>
        <hr />
