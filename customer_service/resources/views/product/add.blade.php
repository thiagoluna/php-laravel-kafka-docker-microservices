            ...
            <!-- 4 campos por linha -->
                <div class="row">
                    <div class="form-group col-md-3">
                        <label for="qtd_available">Quantity Available</label>
                        <input type="text" class="form-control" name="qtd_available" placeholder="Enter the Quantity Available" value="">
                    </div>

                    <div class="form-group col-md-3">
                        <label for="qtd_total">Quantity Total</label>
                        <input type="text" class="form-control" name="qtd_total" placeholder="Enter the Quantity Total" value="">
                    </div>
                </div>
            <hr />
