...
<div id="main" class="container-fluid" style="margin-top: 50px">
    <h3 class="page-header">Add New Order Payment</h3>

    <!-- Área do Form-->
    <form method="post" action="{{route('store.order.payment')}}">
    {{ csrf_field() }}
    <!-- area de campos do form -->
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                <label for="return_date">Description</label>
                <input type="text" class="form-control" name="description" placeholder="Enter the description" value="">
            </div>

            <div class="form-group col-md-3">
                <label for="amount">Amount</label>
                <input type="text" class="form-control" name="amount" placeholder="Enter the amount" value="">
            </div>

            <div class="form-group col-md-3">
                <label for="payment_date">Payment Date</label>
                <input type="date" class="form-control" name="payment_date" placeholder="Enter the payment_date" value="">
            </div>
